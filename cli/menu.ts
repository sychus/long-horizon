...
export interface MenuItem {
  command: string;
  label: string;
  /** Shown under the highlighted entry. */
  detail: string;
}
 ...
 */
function paint(selected: number, title: string, first: boolean): void {
  const lines: string[] = [];
  lines.push("");
 ...
 */
export function showMenu(title: string): Promise<string | null> {
